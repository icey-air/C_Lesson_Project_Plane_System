...
#define ID_EDIT_PASSWORD_2        2016  //再次输入密码输入框ID
...
#define ID_BUTTON_UPDATE_CONFIRM      5023  // 确认修改按钮
#define ID_BUTTON_UPDATE_CANCEL       5024  // 取消修改按钮
#define ID_DIALOG_UPDATE_PLANE        5025  // 修改航班对话框ID
#define ID_EDIT_UPDATE_PLANE_ID       5026
#define ID_EDIT_UPDATE_DEPARTURE      5027
#define ID_EDIT_UPDATE_DESTINATION    5028
#define ID_EDIT_UPDATE_WHOLE_SEAT     5029
#define ID_EDIT_UPDATE_REST_SEAT      5030
#define ID_EDIT_UPDATE_PRIZE          5031
#define ID_EDIT_UPDATE_TAKEOFF_YEAR   5032
#define ID_EDIT_UPDATE_TAKEOFF_MONTH  5033
#define ID_EDIT_UPDATE_TAKEOFF_DAY    5034
#define ID_EDIT_UPDATE_TAKEOFF_HOUR   5035
#define ID_EDIT_UPDATE_TAKEOFF_MINUTE 5036
#define ID_EDIT_UPDATE_LANDING_YEAR   5037
#define ID_EDIT_UPDATE_LANDING_MONTH  5038
#define ID_EDIT_UPDATE_LANDING_DAY    5039
#define ID_EDIT_UPDATE_LANDING_HOUR   5040
#define ID_EDIT_UPDATE_LANDING_MINUTE 5041
...
void Add_New_Passengers_Window(HWND hwnd);void ShowLoginWindow(HWND hwnd);
void ShowLoginWindow(HWND hwnd);
void Add_Passengers_Comfirm_Window(HWND hwnd);
